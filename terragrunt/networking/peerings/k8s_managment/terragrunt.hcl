...
dependency "managment_vnet" {
  config_path = "../../managment_network"
  mock_outputs = {
    name = "managment-vnet"
...
inputs = {
  ...
  source_virtual_network_name = dependency.managment_vnet.outputs.name
  source_virtual_network_id   = dependency.managment_vnet.outputs.id
